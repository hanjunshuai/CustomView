...
import com.hjs.sg.pickerview.R;

import java.util.List;

import pickerview.adapter.ArrayWheelAdapter;
import pickerview.lib.WheelView;
import pickerview.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    private void setDividerType() {
        wv_option1.setDividerType(this.dividerType);
        wv_option2.setDividerType(this.dividerType);
        wv_option3.setDividerType(this.dividerType);
    }
